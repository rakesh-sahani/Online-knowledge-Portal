...
<body>
<form id="form4" name="form4" method="POST" action="studentreg_code.php">
 <?php
...
<table width="60%" border="1" align="center" cellpadding="4" cellspacing="4">
        ...
        <tr>
          <td width="489" align="right" valign="top"><p>&nbsp;</p>
            <table rules="none" width="619" border="1" align="center" cellpadding="5" cellspacing="5">
            <tr>
              <td height="47" colspan="2" align="center" valign="middle"><span class="style13">Sign Up</span><br /></td>
            </tr>
            <tr>
              <td width="248">Student Id</td>
              <td width="330"><span id="sprytextfield2">
                <input name="text1" value="<?php echo $randval1 ?>" type="text" id="text1" size="55" />
            ...
            <tr>
              <td>Date Of Addmission(mm/dd/yy)</td>
