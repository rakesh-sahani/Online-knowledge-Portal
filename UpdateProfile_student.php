...
<body>
<form id="form1" name="form1" method="post" action="UpdateProfile_student_code.php">
...
?>
		  ...
		  <td width="324" height="37"><input name="t1" type="text" id="t1"  value="<?php echo $row["studentregid"];?>" size="44" /></td>
            ...
            <tr>
              ...
              <td>
              <input name="t5" type="text" id="t5" value="<?php echo $row["cource"];?>" size="44" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
              <input name="t7" type="text" id="t7" value="<?php echo $row["semture"];?>" size="44" /></td>
            </tr>
            <tr>
              <td height="37">Date Of Addminsion</td>
              <td>
              <input name="t8" type="text" id="t8" value="<?php echo $row["dateofaddmission"];?>" size="44" /></td>
            </tr>
            <tr>
              <td height="37"><p>&nbsp;</p>
              <p>Address</p></td>
