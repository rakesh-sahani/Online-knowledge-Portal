...
<form id="form1" name="form1" method="post" action="removestudent_code.php">
  <table width="70%" border="1" align="center" cellpadding="0" cellspacing="0" rules="none">
    <tr>
      <td align="center"><img src="img/elearning-online-content-banner.jpg" width="980" height="205" /></td>
    </tr>
    <tr>
      <td align="left" bgcolor="#910B00"><a href="admin.php">Back</a><br /></td>
    </tr>
    <tr>
      <td width="917" valign="top"><p>&nbsp;</p>
        <p>&nbsp;</p>
        <table rules="none" width="536" border="1" align="center" cellpadding="5" cellspacing="5">
        <tr>
